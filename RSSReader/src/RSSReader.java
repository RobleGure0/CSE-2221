...
public final class RSSReader {
    ...
    private static void processItem(XMLTree item, SimpleWriter out) {
        ...
        if (sourceIndex != -1) {
            ...
            String sourceName = item.child(sourceIndex).child(0).label();
        ...
        if (titleIndex != -1) {
            String title = item.child(titleIndex).child(0).label();
            int linkIndex = getChildElement(item, "link");
            if (linkIndex != -1) {
                String linkUrl = item.child(linkIndex).child(0).label();
            ...
            if (descriptionIndex != -1) {
                String description = item.child(descriptionIndex).child(0)
                        .label();
